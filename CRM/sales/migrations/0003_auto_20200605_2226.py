# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2020-06-05 14:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_type', models.CharField(blank=True, choices=[('fulltime', '脱产班'), ('online', '网络班'), ('weekend', '周末班')], max_length=64, null=True, verbose_name='班级及类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, help_text='学生报名后，名字改为真实姓名', max_length=32, null=True, verbose_name='姓名')),
